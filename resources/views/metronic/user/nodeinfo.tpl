...
<div class="page-content-wrapper">   
    ...
    <div class="page-content">
      ...
      <div class="row">
        ...
        {if $user->obfs=='http_simple' || $user->obfs=='http_post' || $user->obfs=='random_head' || $user->obfs=='tls1.2_ticket_auth' || $user->protocol=='verify_simple' || $user->protocol=='verify_deflate' || $user->protocol=='verify_sha1' || $user->protocol=='auth_sha1' || $user->protocol=='auth_sha1_v2' || $user->protocol=='auth_sha1_v4' || $user->protocol=='auth_aes128' || $user->protocol=='auth_aes128_md5' || $user->protocol=='auth_aes128_sha1' || ( $user->obfs=='plain' && $user->protocol=='origin')}		
        <div class="col-md-6">
              <!-- BEGIN Portlet PORTLET-->
              <div class="portlet light bordered">
                  <div class="portlet-title">
