...
<div class="page-content-wrapper">   
    ...
    <div class="page-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
              ...
              <div class="portlet light bordered">
                  ...
                  <div class="portlet-body">
                  	<textarea class="form-control" {if $user->obfs=='http_post' || $user->obfs=='http_simple'} rows="9" {else} rows="8" {/if}>{$json_show}</textarea>                  	
                 	</div>                                    	
            	</div>
            	<!-- END Portlet PORTLET-->
            	<!-- BEGIN Portlet PORTLET-->
        ...
        {if $user->obfs=='http_simple' || $user->obfs=='http_post' || $user->obfs=='random_head' || $user->obfs=='tls1.2_ticket_auth' || $user->protocol=='verify_deflate' || $user->protocol=='verify_sha1' || $user->protocol=='auth_sha1' || $user->protocol=='auth_sha1_v2' || $user->protocol=='auth_sha1_v4' || $user->protocol=='auth_aes128_md5' || $user->protocol=='auth_aes128_sha1' || ( $user->obfs=='plain' && $user->protocol=='origin')}		
        <div class="col-md-6">
              <!-- BEGIN Portlet PORTLET-->
              <div class="portlet light bordered">
                  <div class="portlet-title">
